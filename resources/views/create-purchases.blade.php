...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="flex">
        ...
        <h2 class="text-2xl font-bold mb-6 text-blue-700">Create Purchase</h2>
        ...
        <i class="fas fa-calendar-alt text-gray-500"></i>
                    ...
                    <div>
                        ...
                        <select class="input-field">
                            ...
                            <option>LMN Distributors</option>
                            <option>PQR Suppliers</option>
                            <option>EFG Distributors</option>
                            <option>GHI Distributors</option>
                        </select>
                    </div>
                    </div>
                <div >
                    <div>
                        ...
                        <input type="text" class="input-field" placeholder="Purchase invoice number">
                    </div>
                    <div >
                    <div>
    ...
    <div class="grid grid-cols-3 gap-4 mb-4">
        ...
        <div>
            <label class="block font-medium">Paid Amount:</label>
            <div class="flex items-center">
                <input type="number" class="border rounded-l p-2 w-full">
                <span class="bg-gray-200 px-3 rounded-r">₹</span>
            </div>
        </div>
