...
@section('title', 'Edit Product - Zap Store')
            ...
            <div class="col-span-1">
                <div class="bg-white p-8 shadow-lg rounded-lg">
                    ...
                    <div class="border-2 border-dashed border-gray-300 p-6 text-center rounded-lg hover:border-blue-500 transition-colors">
                        <img id="preview" 
                             src="{{ $product->image ? asset('storage/products/'.$product->image) : 'https://via.placeholder.com/400x400?text=Upload+Image' }}" 
                             alt="Preview" 
                    ...
                    <div class="grid grid-cols-2 gap-8">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name', $product->name) }}" 
                                   class="w-full p-4 text-lg border rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-500 @error('name') border-red-500 @enderror" 
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="code" value="{{ old('code', $product->code) }}" 
                                       class="w-full p-4 pl-12 text-lg border rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-500 @error('code') border-red-500 @enderror" 
                        ...
                        <div>
                            ...
                            <select name="category" class="w-full p-4 text-lg border rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                                ...
                                <option value="food" {{ old('category', $product->category) == 'food' ? 'selected' : '' }}>Food & Beverages</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="stock" value="{{ old('stock', $product->stock) }}" 
                                   class="w-full p-4 text-lg border rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-500 @error('stock') border-red-500 @enderror" 
